...
lib.game_engine_access_portal.argtypes = [GameEngine]
lib.game_engine_access_portal.restype = ctypes.c_int
lib.game_engine_get_treasure_total.argtypes = [GameEngine, ctypes.POINTER(ctypes.c_int)]
lib.game_engine_get_treasure_total.restype = ctypes.c_int
lib.game_engine_get_adjacency_matrix.argtypes = [GameEngine, ctypes.POINTER(ctypes.POINTER(ctypes.c_int))]
